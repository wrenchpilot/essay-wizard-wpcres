...
* Scalable design means an assignment can be completed by innumerable students with no addition to instructor workload
...
1. Upload and unzip `wpCRES.zip` to the `/wp-content/plugins/` directory
