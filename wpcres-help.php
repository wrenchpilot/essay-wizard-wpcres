...
function render_help_page() {
    ...
    <div class="wrap">
        ...
        <h2>wpCRES Help</h2><br />
        <div class="postbox">
            <h3>Creating a new assignment</h3>
            <div class="inside">
                <ol>
        ...
        <div class="postbox">
            <h3>Publishing a new assignment</h3>
            <div class="inside">
                <ol>
        ...
        <div class="postbox">
            <h3>Viewing, approving, rejecting and deleting responses</h3>
            <div class="inside">
                <ol>
        ...
        <div class="postbox">
            <h3>Bulk actions & exporting responses</h3>
            <div class="inside">
                <ol>
                    <li>Click the <strong><a href="edit.php?post_type=wpcres_assignment&page=wpcres-view-responses" target="_blank">Responses</a></strong> link in the <strong>CRES Assignments</strong> menu.</li>
