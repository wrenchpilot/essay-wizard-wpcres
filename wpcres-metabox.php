    ...
    <div id="meta_inner">
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $(".add").click(function(){
                    $('#here').append('<p> <strong>Question</strong> '+(count+1)+' :<br /><textarea name="questions['+count+'][scaffold_question]" cols="60" /></textarea> <br /> <strong>Follow up</strong>:<br /><textarea name="questions['+count+'][scaffold_followup]" cols="60" /> <br /> <strong>Answer</strong>: No <input type="radio" name="questions['+count+'][scaffold_answer]" value="0" /> &nbsp; Yes <input type="radio" name="questions['+count+'][scaffold_answer]" value="1" />&nbsp;&nbsp;&nbsp;<input type="button" class="remove button-secondary" value="Remove Question" /></p><hr />' );
                    count++;
                    return false;
                });
